...
public class GrandExchangeStrategy extends Strategy {
    public static Item[] itemsToBuy = new Item[]{new Item(1993, 1000)};
                ...
                if (Inventory.getFreeSlots() < 2) {
                    ...
                    for (int var3 = 0; var3 < var2; ++var3) {
                        ...
                        if (amountNeeded >= 1) {
                            ...
                            if ((Bank.getContainer().getCount(new int[]{995}) + Inventory.container().getCount(new int[]{995})) / price > amountNeeded) {
                                amountNeeded = MathUtils.clamp(amountNeeded, Bank.getContainer().getCount(new int[]{995}) + Inventory.container().getCount(new int[]{995}) / price, 3000);
                            }
                    ...
                    Thiever.get().setCurrentlyExecutitng(Strategies.DEFAULT);
                }
            }
        }
    }
